    ...
    <div className="min-h-screen flex flex-col items-start justify-between gap-8 md:p-8 md:pb-0 p-4 pt-8 pb-0">
      <div className="space-y-5">
        <div className="flex flex-wrap gap-5 items-center">
          <div className="flex items-center gap-3 shodow-md border border-blue-500 p-4 w-60 rounded-md">
              ...
              <tbody className="text-sm text-gray-500">
                {dashboardData.enrolledStudentsData.map((item, index) => (
                  <tr key={index} className="border border-gray-500/20">
                    ...
                    <td className="md:px-4 px-2 py-3 flex items-center space-x-3 gap-1">
                      <img
                        src={item.student.imageUrl}
                        alt="profile"
                        className="w-9 h-9 roudned-full"
                      />
