...
const AddCourse = () => {
  ...
  const [discount, setdiscont] = useState(0);
  ...
  return (
    <div className="h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0">
      <form
        className="flex flex-col max-w-md gap-4 w-full text-gray-500"
      ...
      >
        ...
        <div>
          ...
          <input
            ...
            min={0}
            max={180}
            className="outline-none md:py-2.5 py-2 w-28 rounded border border-gray-500 px-3"
          />
        </div>
