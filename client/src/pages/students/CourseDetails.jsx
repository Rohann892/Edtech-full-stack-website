    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          <h1 className="md:text-[36px] text-[2px] font-semibold text-gray-800">
          ...
          <p className="pt-2">
            Course by{"  "}
            <span className="text-blue-600 underline">Edu-Tech</span>
          </p>
                    ...
                    <ul className="list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-gray-300">
                      {chapter.chapterContent.map((lecture, i) => (
                        <li key={i} className="flex items-start gap-2 py-1">
                          ...
                          />
                          <div className="flex items-center justify-between w-full text-gray-800 text-sm md:text-[15px]">
        ...
        {/* right column */}
        <div className="max-w-[430px] z-1 shadow-xl rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          {playerData ? (
            <YouTube
          ...
          <div className="p-5">
            ...
            <div className="pt-6">
              ...
              <ul className="ml-8 pt-2 text-sm md:text-[15px] list-disc text-gray-600">
